<div class="flex flex-col gap-6">
                ...
                <div wire:key="product-{{ $product->id }}"
                    ...
                    <div class="p-4 flex flex-col gap-3">
                                ...
                                <div class="space-y-6">
                                    ...
                                    <div class="flex flex-col-reverse sm:flex-row justify-end gap-3 pt-4">
                                        ...
                                        <flux:button type="submit" variant="primary" color="danger"
                                            wire:click="deleteProduct({{ $product->id }})" class="w-full sm:w-auto">
                                            Delete Product
                                        </flux:button>
                                    </div>
                                </div>
                        ...
                        <div class="bg-neutral-50 dark:bg-neutral-800/50 rounded p-2">
                            <div class="flex justify-between items-center">
                                <span class="text-xs font-medium text-neutral-600 dark:text-neutral-400">Margin</span>
    ...
    @else
        <!-- Empty State -->
        <div class="rounded-lg border border-neutral-200 bg-white p-12 dark:border-neutral-700 dark:bg-neutral-900">
